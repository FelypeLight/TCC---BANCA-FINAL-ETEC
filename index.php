    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link active" href="homepageClinica.php">Área Clínica</a></li>
          <li><a class="nav-link scrollto " href="cliente\login.php">Agendar</a></li>
          ...
          <li class="dropdown"><a href="#"><span>Login</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li class="dropdown left-dropdown">
                <a href="cliente/login.php"><span>Login</span> <i class="bi bi-chevron-right"></i></a>
              </li>
              <li class="dropdown left-dropdown">
                <a href="cliente/register.php"><span>Cadastre-se</span> <i class="bi bi-chevron-right"></i></a>              
              </li>
            </ul>
          </li>
    ...
    <div id="heroCarousel" data-bs-interval="5000" class="container carousel carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-item active">
        <div class="carousel-container">
          ...
          <a href="cliente\login.php" class="btn-get-started animate__animated animate__fadeInUp scrollto">Agendar</a>
        </div>
      </div>
      ...
      <div class="carousel-item">
        <div class="carousel-container">
          <h2 class="animate__animated animate__fadeInDown">Cuide do Seu Melhor Amigo com Facilidade!</h2>
          <p class="fs-3 animate__animated animate__fadeInUp">Agende a consulta veterinária online em poucos cliques e
            garanta a saúde do seu pet com conveniência e segurança.</p>
          <a href="cliente\login.php" class="btn-get-started animate__animated animate__fadeInUp scrollto">Agendar</a>
        </div>
      </div>
