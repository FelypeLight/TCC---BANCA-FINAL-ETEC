        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid col-12 ">
                    ...
                    <div class="row">
                        <?php
                        $select2 = "SELECT foto, nm_responsavel, celular, clinica_id, id FROM tb_cliente WHERE clinica_id = $id";

                        // Executar a consulta
                        // Obter resultados
                        $result2 = $mysqli->query($select2);
                        // Inicialize a variável de cards
                        $cards = "";
                        while ($dados2 = $result2->fetch_array()) {
                            $clieid = $dados2['id'];
                            $nm_resp = $dados2['nm_responsavel'];
                            $tell = $dados2['celular'];
        ...
        <div class='col-lg-3 mb-3'>
            <div class='card shadow h-100'>
                <div class='card-header py-3 text-center'>
                    <h6 class='m-0 font-weight-bold text-dark'>$nm_resp</h6>
                    <h6 class='m-0 font-weight-bold text-dark'>Telefone:    $tell</h6>
                </div>
                <div class='card-footer text-center'>
                    <form action='agendaform.php' method='POST'>
                        <input type='hidden' name='cliente' value='" . htmlspecialchars($nm_resp) . "'>
                        <input type='hidden' name='id' value='" . htmlspecialchars($clieid) . "'>
                        <button type='submit' class='btn roverr' style='background-color: #0e213b; color: white' >Agendar</button>
                    </form>
                </div>
            </div>
        </div>";
