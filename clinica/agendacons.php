...
WHERE v.id = $veterinario_id";
    ...
    if ($stmt1->execute()) {
        ...
        $nm_unidade = $row1['clini.nm_unidade'];
...
// }
    ...
    if ($result->num_rows > 0) {
        ...
        header("Location: agendadosMes.php");
        exit();
        ...
        $sql_notification = "INSERT INTO notifications (clinica_id, notificacao, status, data) VALUES ('$clinica_id', '$notificacao', '$status1', '$data')";
