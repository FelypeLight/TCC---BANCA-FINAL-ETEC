...
if ( isset($_POST['status'])) {
    ...
    $query_consultas = "SELECT cons.hr_consulta, cons.dt_consulta, v.clinica_id, status FROM tb_consulta AS cons INNER JOIN tb_veterinario AS v ON cons.veterinario_id = v.id WHERE (status = 'agendada' OR status = 'remarcada') AND v.clinica_id = '14' ";
